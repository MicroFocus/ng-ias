angular.module('app')
    .config(function($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('app.component.avatar', { url: 'avatar', component: 'avatarComponent' })
            ...
            .state('app.component.header', { url: 'header', component: 'headerComponent' })
            ...
            .state('app.component.input', { url: 'input', component: 'inputContainerComponent' })
            ...
            .state('app.component.searchBox', { url: 'search-box', component: 'searchBoxComponent' })
